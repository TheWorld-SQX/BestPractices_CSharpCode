...
- [谁可以创建 或者说 划分出 一个进程 以及 线程](#谁可以创建 或者说 划分出 一个进程 以及 线程)
- [CLR 为什么可以 管理进程和线程](#CLR 为什么可以 管理进程和线程)
...
## 进程是资源分配的基本单位，操作系统怎么知道要给每个进程分配多少计算机资源的
...
<a name="谁可以创建 或者说 划分出 一个进程 以及 线程"></a>
## 谁可以创建 或者说 划分出 一个进程 以及 线程
